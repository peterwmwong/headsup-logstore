...
define(['Bus'], function(Bus) {
  var MAX_LOGS, formatDate, logCount, machineMap, padTime, renderLogs, zeroPad, _;
  _ = cell.prototype.$R;
  logCount = 0;
  MAX_LOGS = 2000;
  ...
  renderLogs = function(logs) {
    ...
    for (_i = 0, _len = logs.length; _i < _len; _i++) {
      l = logs[_i];
      ci = l.clientInfo;
      _results.push(_("<div class='log " + l.category + "' data-logid='" + l.id + "'>", _("<a class='context' " + ((url = machineMap[l.context]) && ("href='" + url + "' target='_blank'") || '') + ">", l.context), _('p.ip', (ci != null ? ci.ip : void 0) || ''), _('p.date', formatDate(l.date)), _('p.siteid', (ci != null ? ci.siteid : void 0) || ''), _('p.district', (ci != null ? ci.district : void 0) && ("(" + ci.district + ")") || ''), _('p.cat', l.category), _('.msg', l.msg)));
    }
    return _results;
  };
  return {
