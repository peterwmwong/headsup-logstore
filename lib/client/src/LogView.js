...
define(['Bus'], function(Bus) {
  ...
  renderLogs = function(logs) {
    var l, url, _i, _len, _ref, _ref2, _ref3, _results;
    _results = [];
    for (_i = 0, _len = logs.length; _i < _len; _i++) {
      l = logs[_i];
      _results.push(_("<div class='log " + l.category + "' data-logid='" + l.id + "'>", _("<a class='context' " + ((url = machineMap[l.context]) && ("href='" + url + "' target='_blank'") || '') + ">", l.context), _('p.ip', ((_ref = l.clientInfo) != null ? _ref.ip : void 0) || ''), _('p.date', l.date && formatDate(l.date || '')), _('p.siteid', ((_ref2 = l.clientInfo) != null ? _ref2.siteid : void 0) || ''), _('p.district', ((_ref3 = l.clientInfo) != null ? _ref3.district : void 0) ? "(" + l.clientInfo.district + ")" : ''), _('p.cat', l.category), _('.msg', l.msg)));
    }
    return _results;
  };
  return {
