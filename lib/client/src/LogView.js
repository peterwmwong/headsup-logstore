...
define(['Bus'], function(Bus) {
  ...
  renderLogs = function(logs) {
    ...
    for (_i = 0, _len = logs.length; _i < _len; _i++) {
      l = logs[_i];
      _results.push(_("<div class='log' data-logid='" + l.id + "'>", _("<a class='context' " + ((url = machineMap[l.context]) && ("href='http://" + url + "' or ''")) + ">", l.context), _('p.ip', ((_ref = l.clientInfo) != null ? _ref.ip : void 0) || ''), _('p.date', l.date && formatDate(l.date || '')), _('p.siteid', ((_ref2 = l.clientInfo) != null ? _ref2.siteid : void 0) || ''), _('p.cat', l.category), _('.msg', l.msg)));
    }
    return _results;
  };
  return {
